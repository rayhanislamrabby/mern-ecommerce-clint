          ...
          <div key={coupon._id} className="relative bg-slate-800 border-2 border-slate-700 p-4 shadow-lg hover:border-cyan-500 transition-all duration-300 group">
            ...
            <div className="flex gap-2 mt-4">
              <button 
                ...
                className="flex-1 py-2 bg- text-black font-black text-[9px] uppercase border-2 border-black shadow-[3px_3px_0px_#000] hover:bg-white hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
              >
                Edit
              </button>
              <button 
