# 🛒 ShopZoon - Full-Stack E-commerce Frontend
...
* **📊 Admin Dashboard:** Real-time business analytics and management tools.
* **🎨 Modern UI:** Built with Tailwind CSS for a fully responsive and clean design.
* **🎫 Coupon Engine:** Dynamic discount application and validation at checkout.

## 🛠️ Tech Stack
* **Frontend:** React.js + Vite
* **Styling:** Tailwind CSS / DaisyUI
* **Auth & Backend Integration:** Firebase Admin SDK & Axios
* **Payment:** Stripe API
